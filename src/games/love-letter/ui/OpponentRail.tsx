...
const OpponentGrid = styled.div`
  width:100%; min-width:0; max-width:680px; margin:0 auto; display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); align-content:start; gap:5px; padding:5px 7px 2px; box-sizing:border-box; overflow:hidden;

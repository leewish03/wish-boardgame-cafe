...
export const PlayerSeat: React.FC<PlayerSeatProps> = ({
  ...
  return (
    ...
    >
      <AvatarRing $isCurrentTurn={isCurrentTurn} $isProtected={player.isProtected}>
...
const AvatarRing = styled.div<{ $isCurrentTurn: boolean; $isProtected: boolean }>`
  position: relative;
  width: 38px;
  height: 38px;
  border-radius: 50%;
